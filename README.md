...
(DS) and Artificial Intelligence (AI). We divide our guidelines chronologically by focusing on four different phases. Each phase is summarised with a box labeled tl;dr (too long; didn't read). However, we encorage you to first read thoroughly the recommendations before refering to the summaries.  
